...
int main(void)
{
	...
	IF_ENABLED(CONFIG_LIB_OSTENTUS,(
		 ...
		 */
		ostentus_slide_add(o_dev, SLIDE_TEMP, LABEL_TEMP, strlen(LABEL_TEMP));
		ostentus_slide_add(o_dev, SLIDE_INTENSITY, LABEL_INTENSITY, strlen(LABEL_INTENSITY));
		ostentus_slide_add(o_dev, SLIDE_VENT, LABEL_VENT, strlen(LABEL_VENT));
		ostentus_slide_add(o_dev, SLIDE_GROWLIGHT, LABEL_GROWLIGHT, strlen(LABEL_GROWLIGHT));
