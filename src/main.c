...
int main(void)
{
	...
	IF_ENABLED(CONFIG_LIB_OSTENTUS,(
		 ...
		 */
		slide_add(SLIDE_TEMP, LABEL_TEMP, strlen(LABEL_TEMP));
		slide_add(SLIDE_INTENSITY, LABEL_INTENSITY, strlen(LABEL_INTENSITY));
		slide_add(SLIDE_VENT, LABEL_VENT, strlen(LABEL_VENT));
		slide_add(SLIDE_GROWLIGHT, LABEL_GROWLIGHT, strlen(LABEL_GROWLIGHT));
